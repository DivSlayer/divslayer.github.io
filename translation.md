...
Import the configuration file at the very top of your main entry file (main.jsx or index.js), right before rendering the app.

import React from 'react';import ReactDOM from 'react-dom/client';import App from './App.jsx';import './i18n'; // <-- Import configuration here
...
If you are working on a larger app, I can show you how to move translations into separate JSON files or how to handle dynamic variables (like "Welcome, John!"). Let me know what you would like to explore next.
